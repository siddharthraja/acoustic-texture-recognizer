        ...
        while index < BUFFER - WINDOW:
            ...
            if t - prevTime > 0.25 and (thumpVotes > 0 or nailVotes > 0 or velcroVotes > 0):
                ...
                if max([thumpVotes, nailVotes, velcroVotes]) < 7:
                    resultTexture = 'FALSE POSITIVE'
                else:
                    if thumpVotes > nailVotes and thumpVotes > velcroVotes: resultTexture = 'THUMP'
                    elif nailVotes > velcroVotes: resultTexture = 'NAIL'
                    else: resultTexture = 'VELCRO'
                if resultTexture == 'THUMP' or resultTexture == 'NAIL' or resultTexture == 'VELCRO':
                    gestureCount += 1
                print resultTexture  + ', ' + str(gestureCount)
